...
public class VentanaPrincipal extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTxtArchivo, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))))))
    ...
    private void jBtnEjecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEjecutarActionPerformed
        if(!jTxtArchivo.getText().equals("") && (jRbtnDiscretas.isSelected() || jRbtnContinuas.isSelected())){
            try {
                ...
                if(jRbtnDiscretas.isSelected() && jTxtArchivo.getText().contains("-d.txt")){
                    grafica.leerArchivo();
                    graficaDiscreta(grafica.getResultadoVariables(), grafica.getInicio(), grafica.getFin());
                }
                else if(jTxtArchivo.getText().contains("-c.txt") && jRbtnContinuas.isSelected()){
                    grafica.leerArchivo();
    ...
    public void graficaDiscreta(ArrayList<Integer> resultados, int inicio, int fin){
        DefaultCategoryDataset datos = new DefaultCategoryDataset(); 
        
        for(int i = 0; i < resultados.size(); i++){
            datos.addValue(resultados.get(i),"Variables Aleatorias",String.valueOf(inicio));
            inicio++;
        }
